...
/**
 * Defines backup_quizgame_activity_task class
 *
...
require_once($CFG->dirroot . '/mod/quizgame/backup/moodle2/backup_quizgame_stepslib.php');
...
class backup_quizgame_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the quizgame.xml file
     */
