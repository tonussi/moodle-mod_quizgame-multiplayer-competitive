...
foreach ($qids_aux as $qid) {
    array_push($dataArrAnswers, $DB->get_records('question_answers', array('question' => $qid), 'id', 'id, question, answer, fraction', IGNORE_MISSING));
}
...
//$content = file_rewrite_pluginfile_urls($json, 'webservice/pluginfile.php', $context->id, 'mod_quizgame', 'quizgame', $quizgame->id);
