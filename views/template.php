...
require_once (dirname(dirname(dirname(dirname(__FILE__)))) . '/mod/quizgame/classes/output/index_page.php');
...
$PAGE->requires->js(new moodle_url($CFG->wwwroot . '/mod/quizgame/components/highcharts/highcharts.js'));
$PAGE->requires->js(new moodle_url($CFG->wwwroot . '/mod/quizgame/components/screenfull/dist/screenfull.min.js'));

$PAGE->requires->js(new moodle_url($CFG->wwwroot . '/mod/quizgame/ng/performances.js'));
$PAGE->requires->js(new moodle_url($CFG->wwwroot . '/mod/quizgame/ng/controller/GeneralPerformancesController.js'));
$PAGE->requires->js(new moodle_url($CFG->wwwroot . '/mod/quizgame/ng/controller/StudentPerformanceController.js'));
