...
loadtemplate('config', array(
    'wwwroot' => $CFG->wwwroot . '/mod/quizgame/',
    'quizgame' => $cm->id,
    'newconfig' => get_string('newconfig', 'mod_quizgame'),
    'name' => get_string('name', 'mod_quizgame'),
    'cfgname' => get_string('cfgname', 'mod_quizgame'),
    'adddescr' => get_string('adddescr', 'mod_quizgame'),
    'descr' => get_string('descr', 'mod_quizgame'),
    'addtime' => get_string('addtime', 'mod_quizgame'),
    'tempo' => get_string('tempo', 'mod_quizgame'),
