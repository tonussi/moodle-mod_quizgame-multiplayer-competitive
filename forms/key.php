...
loadtemplate('key', array(
    'wwwroot' => $CFG->wwwroot . '/mod/quizgame/',
    'quizgame' => $cm->id,
    'configids' => $configid_toform,
    'newkey' => get_string('newkey', 'mod_quizgame'),
    'selectcfg' => get_string('selectcfg', 'mod_quizgame'),
    'configname' => get_string('configname', 'mod_quizgame'),
    'generatekey' => get_string('generatekey', 'mod_quizgame'),
    'randomnumber' => get_string('randomnumber', 'mod_quizgame'),
