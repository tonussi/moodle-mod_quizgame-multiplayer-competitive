...
$PAGE->requires->js(new moodle_url($CFG->wwwroot . '/mod/quizgame/ng/package.js'));
...
if ($catid == 0) {
    // Alert teacher that category id is missing
    echo '<div class="alert alert-warning">Volte e escolhe uma categoria da lista.</div>';
}

$configs = $DB->get_records('quizgame_game_configuration', array(
...
loadtemplate('package', array(
    'wwwroot' => $CFG->wwwroot . '/mod/quizgame/',
    'quizgame' => $cm->id,
    'questions' => $questions_toform,
    'configids' => $configid_toform,
    'packagecfg' => get_string('packagecfg', 'mod_quizgame'),
    'selectcfg' => get_string('selectcfg', 'mod_quizgame'),
    'config' => get_string('config', 'mod_quizgame'),
    'selectquestions' => get_string('selectquestions', 'mod_quizgame'),
    'questionsinfo' => get_string('questionsinfo', 'mod_quizgame'),
    'savepackage' => get_string('savepackage', 'mod_quizgame'),
