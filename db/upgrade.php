...
function xmldb_quizgame_upgrade($oldversion) {
     ...
     * for demonstrative purposes and to show how the quizgame
     * iself has been upgraded.
     *
     * For each upgrade block, the file quizgame/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to quizgame.
        ...
        // Define field intro to be added to quizgame.
        $table = new xmldb_table('quizgame');
        ...
        // Define field introformat to be added to quizgame.
        $table = new xmldb_table('quizgame');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'quizgame');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to quizgame.
        $table = new xmldb_table('quizgame');
        ...
        // Define field timemodified to be added to quizgame.
        $table = new xmldb_table('quizgame');
        ...
        // Define index course (not unique) to be added to quizgame.
        $table = new xmldb_table('quizgame');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'quizgame');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'quizgame');
    }
